  ...
  return (
    ...
    {isMobile && window.innerWidth < 768  && <div>
      ...
      >
        <div
              ref={nodeRef}
              className=" bg-violet-100 rounded-xl w-full h-full cursor-move border-4 border-violet-500"
              >
              <div className="flex rounded-t-md bg-violet-500 p-2">
              ...
              <div>
                <div className="overflow-y-auto">
                  ...
                  <div>
                      ...
                      <div className="h-96 ">
                        <Card img_url="/img/secondBrain.png" title="Second Brain" description="One of my first Project made in full MERN stack . It is like essential space , where one can store all his important digital documents , links , notes etc..." link="https://github.com/WhizASh/second_brain_demo" isMobile={true}/>
                        <Card img_url="img/quiz.png" title="Quiz App" description="A Quiz Game made in Django Python. One of my Projects i worked on during my internship." link="https://github.com/WhizASh/Quiz-Website-in-django" isMobile={true}/>
                        <Card img_url="img/gameoflife.png" title="Convay's Game of life" description="A simple simulation based on 2 simple rules . It is based on Conway's game of life." link="https://github.com/WhizASh/Game-of-life" isMobile={true}/>
                        <Card img_url="img/snake.png" title="Snake Game" description="A Good Old Snake Game . One of my first projects in typescript. It was simple but got a lot to learn . The game has difficulty settings easy , medium , hard." link="https://github.com/WhizASh/The-Snake-Game" isMobile={true}/>
                        <Card img_url="/img/java_keyboard.png" title="Java Swing Virtual Keyboard" description="The Java Virtual Keyboard with Swing is a graphical user interface application that simulates a virtual keyboard. This project is built using Java Swing to provide a simple and interactive way to input characters" link="https://github.com/WhizASh/Swing_Virtual_Keyboard" isMobile={true}/>
                        <Card img_url="/img/booknest.png" title="Booknest - Online Marketplace for used books" description="A website made in Django Python. Made as a project during my time in diploma. Basically a 2nd hand book selling website.  " link="https://github.com/WhizASh/BookNest" isMobile={true}/>
                      </div>
                  </div>
